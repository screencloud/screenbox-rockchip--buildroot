...
define SECURITYAUTH_BUILD_CMDS
	...
	$(INSTALL) -D -m 0644 $(@D)/$(CHIP_NAME)/optee_armtz/* $(TARGET_DIR)/lib/optee_armtz/

	$(INSTALL) -D -m 0644 $(@D)/$(CHIP_NAME)/bin/* $(TARGET_DIR)/usr/bin/

	$(INSTALL) -D -m 0644 $(@D)/$(CHIP_NAME)/lib/* $(TARGET_DIR)/usr/lib/
endef
endif
